                                        ...
                                        <form id="car_enquiry_form" method="post" action="includes/deals-submit-car-enquiry.php">
                                            ...
                                            <div class="row">
                                              ...
                                              <div class="col-md-4 col-sm-12 col-xs-12">
                                                <div class="form-group form-group-lg form-group-icon-left"><i class="fa fa-phone input-icon input-icon-hightlight"></i>
                                                  <label>Customer Phone <span class="clrred">*</span></label>
                                                  <input placeholder="Enter Valid Contact" id="phone" name="phone" class="form-control" type="text" value="" />
                                                </div>
                                              </div>
                                            </div>  
                        ...
                        <li>
                            ...
                            <a href="javascript:select_flight('Heathrow','LHR','Bangkok','BKK','LX','Swiss','489','ZRH','Zurich','02-May-2023','1')" title="Top Flight Deals To Bangkok">
                                <div class="row">
                                    ...
                                    <div class="col-xs-4 col-sm-3 col-md-3 home-dest"><span class="booking-item-price-from">from</span><span class="booking-item-price" style="font-size:24px; font-weight:bold;">&pound;489</span>
                        ...
                        <li>
                            ...
                            <a href="javascript:select_flight('Heathrow','LHR','Kathmandu','KTM','UK','TATA SIA AIRLINES','697','DEL','Delhi','02-May-2023','1')" title="Hot Flight Deals To Kathmandu">
                                <div class="row">
                                    ...
                                    <div class="col-xs-4 col-sm-3 col-md-3 home-dest"><span class="booking-item-price-from">from</span><span class="booking-item-price" style="font-size:24px; font-weight:bold;">&pound;697</span>
                                    <span class="booking-item-price-from">Incl. Taxes</span></div>
                                </div>
                                </a>
                            </div>
                ...
                <div class="row row-wrap"> 
                    ...
                    <div class="row deal-links">
                        <div class="col-xs-12 col-sm-12 col-md-9 col-lg-9">
                            ...
                            <li><a href="/Summer-Flights-Sale">Summer Flights Sale</a>
                            </li>
...
<!--             <div class="secure-logo">
                 <img src="img/comodo_secure_seal_100x85_transp.png" alt="Comodo Secure Seal" />
</div>-->
        </footer>

<div id="alert_box" class="modal fade thank-you" role="dialog">
...
TrustLogo("https://www.travelelink.co.uk/img/secure_site.gif", "SC5", "none");
</script>
-->

<script language="JavaScript" type="text/javascript">
TrustLogo("https://www.travelelink.co.uk/img/positivessl_trust_seal_md_167x42.png", "CL1", "none");
</script>
...
$(function() {
	...
	$('.btn2').click(function(){
		var selval;
		if($(this).find('input').attr('name') == 'adoptions1'){
		selval = $(this).find('input').attr('id');
		$('#frmsearchflights1 select[name=adults]').val(selval);
		}
		if($(this).find('input').attr('name') == 'adoptions2'){
		selval = $(this).find('input').attr('id');
		$('#frmsearchflights2 select[name=adults]').val(selval);
		}
		
		if($(this).find('input').attr('name') == 'choptions1'){
		selval = $(this).find('input').attr('id');
		$('#frmsearchflights1 select[name=children]').val(selval);
		}
		if($(this).find('input').attr('name') == 'choptions2'){
		selval = $(this).find('input').attr('id');
		$('#frmsearchflights2 select[name=children]').val(selval);
		}
		
		if($(this).find('input').attr('name') == 'inoptions1'){
		selval = $(this).find('input').attr('id');
		$('#frmsearchflights1 select[name=infants]').val(selval);
		}
		if($(this).find('input').attr('name') == 'inoptions2'){
		selval = $(this).find('input').attr('id');
		$('#frmsearchflights2 select[name=infants]').val(selval);
		}
	}); 
	...
	$("#btnsearch1").click(function() {
		...
		if($('#frmsearchflights1 input[name=departure_airport]').val() == '') { errMsg += '&bull;&nbsp;&nbsp;Please Enter Departure City.<br/>';  erorrchk = 1; }
		if($('#frmsearchflights1 input[name=destination_airport]').val() == '') { errMsg += '&bull;&nbsp;&nbsp;Please Enter Destination City.<br/>';  erorrchk = 1; }
		if($('#frmsearchflights1 input[name=departure_date]').val() == '') { errMsg += '&bull;&nbsp;&nbsp;Please Select Departure Date.<br/>';  erorrchk = 1; }
		if($('#frmsearchflights1 input[name=return_date]').val() == '') { errMsg += '&bull;&nbsp;&nbsp;Please Select Return Date.<br/>';  erorrchk = 1; }
